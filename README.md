...
| [master](https://github.com/nschlia/ffmpegfs/tree/master) | gcc 9.3.0    | FFmpeg 4.2.4-1ubuntu0.1 | [![C/C++ CI](https://github.com/nschlia/ffmpegfs/actions/workflows/make-c-cpp.yml/badge.svg)](https://github.com/nschlia/ffmpegfs/actions/workflows/make-c-cpp.yml) [![Build Docker Image CI](https://github.com/nschlia/ffmpegfs/actions/workflows/docker-image.yml/badge.svg)](https://github.com/nschlia/ffmpegfs/actions/workflows/docker-image.yml) [![CodeQL](https://github.com/nschlia/ffmpegfs/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/nschlia/ffmpegfs/actions/workflows/codeql-analysis.yml)|
