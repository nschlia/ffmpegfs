 ...
 * @param[in] fmt_ctx - Format context of file, may be nullptr
 ...
 */
int check_cuesheet(const std::string & filename, void *buf = nullptr, fuse_fill_dir_t filler = nullptr, AVFormatContext *fmt_ctx = nullptr);
