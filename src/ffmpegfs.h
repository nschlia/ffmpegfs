...
extern struct FFMPEGFS_PARAMS
{
    ...
    STRINGSET*              m_include_extensions;           /**< @brief Set of extensions to include. If empty, include all. Must be a pointer as the fuse API cannot handle advanced c++ objects. */
