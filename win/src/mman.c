// Code was published on https://code.google.com/p/mman-win32/
// This version taken from https://github.com/alitrack/mman-win32
//
...
#include "sys/mman.h"       // Changed from <mman.h>
...
static int __map_mman_error(const DWORD err, const int deferr)
{
    if (err == 0)
        return 0;
    //TODO: implement
    return (int)err;        // Added cast to silence warning
}
